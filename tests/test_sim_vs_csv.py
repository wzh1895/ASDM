...
def test_simulation_output_vs_csv(model_path, csv_path):
    ...
    difference_mask = np.abs(df_model - df_reference) > 1e-5 # there seems to be a precision cut off in Stella (e.g., Simulated=13865782.79459000, Reference=13865782.79460000, Diff= -0.00001000)
